...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveBooking(long userId, BookingRequestDto booking) {
    ...
    public ResponseEntity<Object> getBookingByBooker(long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
