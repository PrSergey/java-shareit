...
class ItemRequestControllerTest {
    ...
    @SneakyThrows
    @Test
    void getItemRequests_whenNumberOfFirstElementsOnPageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String from = "-5";
        String size = "2";
        ...
        verify(itemRequestService, never())
                .getItemRequests(userId, pageRequest);
    }

    @SneakyThrows
    @Test
    void getItemRequests_whenNumberOfSizePageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String from = "5";
        String size = "-2";
        PageRequest pageRequest = PageRequest.of(2, 2);
