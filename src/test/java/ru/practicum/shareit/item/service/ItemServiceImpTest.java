...
class ItemServiceImpTest {
    ...
    @Test
    void add_whenItemDtoAvailableIsNull_thenValidationExceptionThrow() {
        ...
        assertEquals(ex.getMessage(), "При добавление вещи, не указан статус доступности");
    }

    @Test
    void add_whenItemDtoNameIsNull_thenValidationExceptionThrow() {
        ItemDto itemDto = ItemMapper.toItemDto(createItem());
        ...
        ValidationException ex = assertThrows(ValidationException.class,
                () -> itemService.add(userId, itemDto));
        assertEquals(ex.getMessage(), "При добавление вещи, не указано имя");
    }

    @Test
    void add_whenItemDtoNameIsBlank_thenValidationExceptionThrow() {
        ItemDto itemDto = ItemMapper.toItemDto(createItem());
        itemDto.setName(" ");
        long userId = 1L;
    ...
    @Test
    void add_whenItemDtoDescriptionIsNull_thenValidationExceptionThrow() {
        ItemDto itemDto = ItemMapper.toItemDto(createItem());
        ...
        ValidationException ex = assertThrows(ValidationException.class,
                () -> itemService.add(userId, itemDto));
        assertEquals(ex.getMessage(), "При добавление вещи, нет описания");
    }
