...
class ItemControllerIT {
    ...
    @SneakyThrows
    @Test
    void getUsersItem_whenNumberOfFirstElementsOnPageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String from = "-5";
        String size = "2";
        ...
        verify(itemService, never())
                .getUsersItem(userId, pageRequest);
    }

    @SneakyThrows
    @Test
    void getUsersItem_whenNumberOfSizePageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String from = "2";
        String size = "-2";
        PageRequest pageRequest = PageRequest.of(2, 2);
    ...
    @SneakyThrows
    @Test
    void searchItem_whenNumberOfSizePageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String from = "2";
        String size = "-2";
        String text = "text";
        ...
        verify(itemService, never())
                .searchItem(text, pageRequest);
    }

    @SneakyThrows
    @Test
    void whenNumberOfFirstElementsOnPageIsNotValid_whenValidationException() {
        Long userId = 1L;
        String from = "-2";
        String size = "2";
        String text = "text";
