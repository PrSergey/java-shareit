...
class BookingControllerTest {
    ...
    @SneakyThrows
    @Test
    void getBookingByBooker_whenNumberOfFirstElementsOnPageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String state = "ALL";
        String from = "-5";
        String size = "2";
        ...
        verify(bookingService, never())
                .getBookingByBooker(userId, state, pageRequest);

    }

    @SneakyThrows
    @Test
    void getBookingByBooker_whenNumberOfSizePageIsNotValid_thenValidationException() {
        Long userId = 1L;
        String state = "ALL";
        String from = "1";
        String size = "0";
